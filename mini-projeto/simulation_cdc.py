...
bronze_path = "/workspace/data/bronze/orders"
silver_path = "/workspace/data/silver/orders"
...
if DeltaTable.isDeltaTable(spark, bronze_path):
    ...
    orders_bronze_df = spark.read.csv("/workspace/data/new_orders.csv", header=True, inferSchema=True)
