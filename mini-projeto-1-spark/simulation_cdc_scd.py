...
silver_customers_path = "/workspace/data/silver/customers"
silver_orders_path = "/workspace/data/silver/orders"
silver_inventory_path = "/workspace/data/silver/inventory_movements"

# 1. Carga Incremental de Pedidos e Movimentações de Estoque
orders_incremental_df = spark.read.csv("/workspace/data/bronze/orders_incremental.csv", header=True, inferSchema=True)
inventory_incremental_df = spark.read.csv("/workspace/data/bronze/inventory_movements_incremental.csv", header=True, inferSchema=True)
...
customers_incremental_df = spark.read.json("/workspace/data/bronze/customers_incremental.json")
